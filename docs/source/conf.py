...
import sys, os
from cloudmesh.nlp.__version__ import version as nlp_version

rtd = True
# rtd = False

sys.path.insert(0, os.path.abspath('..'))
import cloudmesh.nlp
...
if not rtd:
    ...
    html_sidebars = {
        "**": [# "logo-text.html",
               ...
               "localtoc.html",
               "genindex.html",
               "generated/cloudmesh.nlp.html"]}
    html_theme_options = {
        'repo_url': 'https://github.com/cloudmesh/cloudmesh-nlp'
    }
else:
    html_sidebars = { '**': [
        'globaltoc.html',
